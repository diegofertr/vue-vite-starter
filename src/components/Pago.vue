<template>
  <h1 class="text-4xl mb-4">Pagos</h1>
  <!-- <button class="p-2 bg-indigo-500 rounded text-white">
    <span class="ml-2">Realizar Pago</span>
  </button> -->
  <button class="text-lg inline-flex px-5 py-3 my-4 bg-transparent rounded-md text-indigo-500 hover:bg-indigo-50">
