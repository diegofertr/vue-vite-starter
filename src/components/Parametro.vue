                ...
                <div class="mt-2">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="clave" id="clave" v-model="formState.clave" autocomplete="given-name" class="mt-1 p-2 bg-gray-100 focus:ring-indigo-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-red-600 rounded-md">
                    </div>

                    <div class="col-span-6 sm:col-span-3">
                      <label for="last-name" class="block text-sm font-medium text-gray-700">Valor</label>
                      <input type="text" name="valor" id="valor" v-model="formState.valor" autocomplete="family-name" class="mt-1 p-2 bg-gray-100 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                  </div>
                </div>
              </div>
