            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="(param, idx) in params" :key="idx">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <button @click="onEditItem(param)" class="text-yellow-400 hover:text-yellow-500 inline-flex">
                  ...
                  <button @click="onDeleteItem(param['id'])" class="text-red-400 hover:text-red-500 inline-flex ml-2">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <form @submit.prevent="saveParametro" method="POST">
                  ...
                  <div class="grid grid-cols-1 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        class="mt-1 p-2 bg-gray-100 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-primary rounded-md"
                      >
                    </div>
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              type="submit"
              class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary sm:ml-3 sm:w-auto sm:text-sm"
            >
              Guardar cambios
            </button>
            <button
